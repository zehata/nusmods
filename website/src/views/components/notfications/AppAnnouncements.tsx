...
import styles from './AppAnnouncements.scss';
...
const AppAnnouncements = memo(() => {
  ...
  return (
    <Announcements dismissAction={key ? dismiss : undefined} icon="heart">
      <h3>AY2025/26 courses now available!</h3>
      <p className={styles.bodyElement}>
        NUSMods now has AY2025/26 course information available. The data is accurate but subject to
        changes.
      </p>
      <p className={styles.bodyElement}>
