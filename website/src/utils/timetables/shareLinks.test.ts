...
import {
  deserializeSemTimetableConfig,
  getImportedModuleCodes,
  serializeSemTimetableConfig,
} from './shareLinks';
...
describe('timetable serialization/deserialization', () => {
  ...
  const deserialize = (serializedConfig: string) =>
    deserializeSemTimetableConfig(serializedConfig, modules, semester);
  ...
  describe('deserialized config should be identical to config that was serialized', () => {
    const serializeThenDeserialize = (config: {
      ...
      hidden: ModuleCode[];
      ta: ModuleCode[];
    }) => deserialize(serializeSemTimetableConfig(config));
  ...
  describe('deserializing v3 format', () => {
    ...
    describe('edge cases', () => {
      ...
      test('invalid lesson type are excluded, other lesson types should be deserialized correctly', () => {
        expect(
          deserialize(
            'CS1010S=ABC:1,REC:2,TUT:3' +
              '&CS4243=LAB:(2|TUE|1600|1800|AS6-0421|3_4_5_6_7_8_9_10_11_12_13);ABC:()' +
              '&ta=CS4243',
          ),
        ).toStrictEqual({
          semTimetableConfig: {
  ...
  describe('deserializing v2 strings', () => {
    ...
    describe('deserializing edge cases', () => {
      ...
      test('invalid lesson types are excluded, other lesson types should be deserialized correctly', () => {
        expect(
          deserialize(
            'CS1010S=ABC:(1);REC:(3);TUT:(30)' + '&CS4243=LAB:(1);DEF:(5)' + '&ta=CS4243',
          ),
        ).toStrictEqual({
          semTimetableConfig: {
            CS1010S: {
      ...
      test('ignore invalid lessonIndex, other lesson types should be deserialized correctly', () => {
        expect(
          deserialize(
  ...
  describe('deserializing v1 strings', () => {
    ...
    describe('deserializing edge cases', () => {
      ...
      test('invalid lesson type in TA lesson config', () => {
        expect(
          deserialize('CS1010S=ABC:1,REC:2,TUT:3' + '&CS4243=LAB:2,LEC:1' + '&ta=CS4243(ABC:1)'),
        ).toStrictEqual({
          semTimetableConfig: {
            CS1010S: {
              Recitation: ['2'],
