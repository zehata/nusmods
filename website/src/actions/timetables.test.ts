...
describe('fillTimetableBlanks', () => {
  ...
  test('fill non-TA modules that has missing lessons with first classNo, ignore TA modules with missing lessons', async () => {
    const timetable = {
      CS1010S: {
        Lecture: ['1'],
        Tutorial: ['3'],
  ...
  test('should not change v3 config', async () => {
