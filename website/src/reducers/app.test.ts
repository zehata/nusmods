...
import { LessonWithSerializedDetails } from 'types/timetables';

const semester: Semester = 1;
const anotherSemester: Semester = 2;
const lesson: LessonWithSerializedDetails = lessons[0];
...
test('app should set active lesson', () => {
  const anotherLesson: LessonWithSerializedDetails = lessons[1];
