...
// Raw lessons obtained from venue info API includes ModuleCode and without venue and without serializedLessonDetails
export type VenueLesson = Omit<RawLesson, 'venue' | 'serializedLessonDetails'> & {
